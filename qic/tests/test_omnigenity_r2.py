...
class NewtonTests(unittest.TestCase):
    ...
    def test_omnigenity(self):
        ...
        stel = Qic(
            ...
            d_over_curvature={"type": "scalar", "input_value": 1.0},
            nphi=nphi,
            omn=True,
            omn_buffer={"omn_method": "non-zone", "delta": delta},
            X2c = {"type": "fourier", "input_value": {"cos": B2c_cvals, "sin": B2c_svals}},
            X2s = {"type": "fourier", "input_value": {"cos": B2s_cvals, "sin": B2s_svals}},
            order = "r2"
        )
