...
def quartic_roots(p):
    ...
    If a single quartic equation or a set of fewer than 50 equations is
    given as an input, this function will call `single_quartic` inside
    a list comprehension. Otherwise (if a more than 50 equtions is given), it
